...
public class VowRecy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vowrecy);
        ...
        myGroup temp = new myGroup("He ate apple", "");
        temp.child.add("그는 사과를 먹었다");
        temp.child2.add("");
        temp.child3.add("");

        DataList.add(temp);
        temp = new myGroup("The ant is tiny", "");
        temp.child.add("개미는 작다");
        temp.child2.add("");
        temp.child3.add("");

        DataList.add(temp);
        temp = new myGroup("She shot the arrow into the air", "");
        temp.child.add("그녀는 공기중으로 화살을 쐈다");
        temp.child2.add("");
        temp.child3.add("");

        DataList.add(temp);
        temp = new myGroup("He uses the ax to cut wood", "");
        temp.child.add("그는 나무를 자르는데 도끼를 사용한다");
        temp.child2.add("");
        temp.child3.add("");

        DataList.add(temp);
        temp = new myGroup("Alligator is a large reptile", "");
        temp.child.add("악어는 큰 파충류이다");
        temp.child2.add("");
        temp.child3.add("");
...
//        getData();
        ...
        final ImageButton Cons = findViewById(R.id.word); // activity_main에서 liveButton을 가져옴
        Cons.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(VowRecy.this, recy.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent);

            }
        });

//        final Button Vow = findViewById(R.id.vow); // activity_main에서 liveButton을 가져옴
//        Vow.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
//            public void onClick(View v) {
//                final Intent intent = new Intent(VowRecy.this, VowRecy.class); // 버튼 누르면 objectdetection 시작
//                startActivity(intent);
//
//            }
//        });
...
//            public void onClick(View v) {
//                final Intent intent = new Intent(VowRecy.this, ABCDRecy.class); // 버튼 누르면 objectdetection 시작
//                startActivity(intent);
//
//            }
//        });
        ...
        Test.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(VowRecy.this, TestActivity.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent);
            }
        });
        ...
        Profile.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(VowRecy.this, Profile.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent);
            }
        });
        ...
        buttonLive5.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(VowRecy.this, AbstractCameraXActivity.class); // 버튼 누르면 objectdetection 시작
        ...
        back_to_main.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(VowRecy.this, MainActivity.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent); // intent = 컴포넌트를 실행하기 위해 시스템에 전달하는 메세지 객체
            }
        });
    }
