...
//                        Log.d("compare", "o1 : " + o1.score);
//                        Log.d("compare", "o2 : " + o2.score);
        ...
        for (int i=0; i<boxes.size() && !done; i++) {
            if (active[i]) {
                ...
                selected.add(boxA);
                Log.d("boxA", "Box A: " + boxA.getCls());
                Log.d("boxA", "Box score: " + boxA.getScore());
//                int cnt = 0;
//                for (Result select : selected) {
//                    if (select.equals("F")) {
//                        cnt += 1;
//                        if (select.equals("O")) {
//                            cnt += 1;
...
//                Result alp1 = selected.get(0);
//
//                if ( alp1 == selected.get(0) )  {
//                }
