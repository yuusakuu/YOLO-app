...
public class NounActivity extends AppCompatActivity implements Runnable {
    ...
    private Button Verb, Prase, Test;
...
//        mResultView.setVisibility(View.INVISIBLE);
        ...
        Verb.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(NounActivity.this, VerbActivity.class); // 버튼 누르면 objectdetection 시작
        ...
        Prase.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(NounActivity.this, PraseActivity.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent);
        ...
        Test.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(NounActivity.this, TestActivity.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent);
        ...
        buttonLive.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                ...
                final Intent intent = new Intent(NounActivity.this, AbstractCameraXActivity.class); // 버튼 누르면 objectdetection 시작
...
//                startActivity(intent3);
        ...
        back_to_main.setOnClickListener(new View.OnClickListener() {    // buttonLive를 누르면 실행되도록
            public void onClick(View v) {
                final Intent intent = new Intent(NounActivity.this, MainActivity.class); // 버튼 누르면 objectdetection 시작
                startActivity(intent); // intent = 컴포넌트를 실행하기 위해 시스템에 전달하는 메세지 객체
            }
        });
